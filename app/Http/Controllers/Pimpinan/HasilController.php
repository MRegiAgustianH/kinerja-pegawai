...
class HasilController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('pimpinan.hasil.index', compact('periode', 'idPeriode', 'hasil', 'divisiList', 'kelompokKerja', 'idDivisi'));
    }
    ...
    public function pdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('pimpinan.hasil.pdf', compact('hasil', 'periode', 'kelompokKerja', 'selectedDivisi'))->setPaper('a4', 'portrait');
