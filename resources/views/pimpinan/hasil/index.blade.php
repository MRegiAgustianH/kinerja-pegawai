...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('pimpinan.hasil.pdf', ['periode' => $idPeriode]) }}" class="btn btn-sm btn-outline-danger"><i class="bi bi-file-pdf"></i> Cetak PDF</a>
</div>
...
<div class="table-responsive"><table class="table table-sm table-hover align-middle">
    ...
    @empty <tr><td colspan="7" class="text-center text-muted py-3">Belum ada hasil.</td></tr>@endforelse
    </tbody>
</table></div>
</div></div>
{{ $hasil->links() }}
