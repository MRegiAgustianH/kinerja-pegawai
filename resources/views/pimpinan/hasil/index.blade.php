    ...
    <div class="card-body py-3">
        <form method="get" class="row g-2 align-items-end">
            ...
            <div class="col-md-3 text-end">
                <a href="{{ route('pimpinan.hasil.pdf', ['periode' => $idPeriode, 'kelompok_kerja' => $kelompokKerja, 'divisi' => $idDivisi]) }}" class="btn btn-sm btn-outline-danger w-100"><i class="bi bi-file-pdf me-1"></i> Cetak PDF</a>
            </div>
        </form>
    </div>
</div>
...
<div class="table-responsive"><table class="table table-sm table-hover align-middle">
    ...
    @empty <tr><td colspan="8" class="text-center text-muted py-3">Belum ada hasil.</td></tr>@endforelse
    </tbody>
</table></div>
</div></div>
{{ $hasil->links() }}
